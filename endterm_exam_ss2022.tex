...
&
\colorbox{gray!50}{$
+ \frac{1}{6} g_{xxx} \left((x_{t-1} - \bar{x}) \otimes (x_{t-1} - \bar{x}) \otimes (x_{t-1} - \bar{x})\right) %+ 1/6*gxxx*kron(xhat,kron(xhat,xhat)) ...
+ \frac{1}{6} g_{uuu} \left(u_t \otimes u_t \otimes u_t\right) % + 1/6*guuu*kron(u,kron(u,u)) ...
$}
\\
&
\qquad
\colorbox{gray!50}{$
+ \frac{3}{6} g_{xxu} \left((x_{t-1} - \bar{x}) \otimes (x_{t-1} - \bar{x}) \otimes u_t \right) %+ 3/6*gxxu*kron(xhat,kron(xhat,u)) ...
+ \frac{3}{6} g_{xuu} \left((x_{t-1} - \bar{x}) \otimes u_t \otimes u_t \right) %+ 3/6*gxuu*kron(xhat,kron(u,u)) ...
$}
\\
&
\qquad\qquad
...
\qquad\qquad\qquad
\colorbox{gray!50}{$
+ \frac{3}{6} g_{x\sigma\sigma} (x_{t-1} - \bar{x}) %+ 3/6*gxss*xhat ...
+ \frac{3}{6} g_{u\sigma\sigma} u_t %+ 3/6*guss*u ...
$}
\\
&
\qquad\qquad\qquad\qquad
\colorbox{gray!50}{$
+ \frac{1}{6} g_{\sigma\sigma\sigma} % + 1/6*gsss;
$}
\end{align*}
