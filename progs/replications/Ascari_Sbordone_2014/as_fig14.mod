...
shocks;
var eps_nu = 1; % 1 percent monetary policy shock, because interest rate is in logs
var eps_a = 0;
var eps_zeta = 0;
end;

TREND_INFLATION=0;
stoch_simul(order=1,irf=7,irf_plot_threshold=0,nograph) log_y log_pi log_r log_s log_i nu;
