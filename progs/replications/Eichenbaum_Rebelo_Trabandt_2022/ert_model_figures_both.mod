% =========================================================================
% Replicates Figures 9 and 10 of
...
% create figures
plot_also_flex_price_model = true;
ert_model_plot_agg_results("both",M_,oo_,plot_also_flex_price_model);
ert_model_plot_by_type_results("both",M_,oo_);