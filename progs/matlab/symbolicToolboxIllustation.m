...
clearvars
syms(sym('a', [1 10]))
% The MATLAB workspace contains 10 MATLAB variables which are symbolic and each has 1 entry
...
% evaluate expressions by substituting numerical values to the symbolic variables in the workspace (VERY SLOW)
rng(123); % get same random numbers by setting seed
tic;
for j=1:1000
