...
% helper function inside the steady_state_model block to numerically
% compute labor in steady-state
% -------------------------------------------------------------------------
...
n = rbcCRRASteadyStateHelperFunction(n0,PSI,ETAL,ETAC,GAMMA,c_n,w);
c = c_n*n;
iv = iv_n*n;
k = k_n*n;
y = y_n*n;
