...
varexo
e           ${\epsilon^a}$     (long_name='productivity shock')
;
...
%stoch_simul(order=1) rf_ann rk_ann rp_ann;
stoch_simul(order=2) rf_ann rk_ann rp_ann;
%stoch_simul(order=5, periods=20000) rf_ann rk_ann rp_ann;
